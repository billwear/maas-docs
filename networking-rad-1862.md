...
![subnets page](upload://b2kzjp3F7Xm1C4oboDTL96AdkTU.png)
...
![networking subnets page summary](upload://gOOF3eeeVpbnmuts40HjayqwigB.png)
...
![networking subnets utilisation](upload://aubNLQlLnh6Jv7UPgZMkllOOfsR.png)
...
![networking static routes configuration](upload://6nNNydd04oXocGv0A5Sla50u7tf.png)

<h4>Reserved ranges</h4>

The reserved ranges section of the subnet screen looks like this:

![networking subnets reserved](upload://etB5PZmZU7KGCrJB8l9FcePOR0o.png)
...
![networking subnets used](upload://jEW8CoXFsKoJggd2522dG5nuyqP.png)
