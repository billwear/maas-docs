...
![power types undefined](upload://67X91tabTrVafapqLo2L1nhKRsb.png)

Choose a type in the dropdown menu that corresponds to the machine's underlying machine's BMC card.

![power types selection](upload://48oFBi3BVK3IqMzOXmaJpIeM4JP.png)
...
![power types power error](upload://gUxKOnPu88oAKw9eUY1SSx4rxkM.png)
...
![power types example: virsh](upload://a6xLVrudhYAYFUJHtaOmPS1ZCOf.png)
